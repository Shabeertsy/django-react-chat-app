      ...
      <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-30">
        <div className="text-center px-4">
          ...
          <div className="mt-6 flex justify-center space-x-4">
            <a href="" className="bg-cyan-400 text-white px-5 py-2 rounded-lg text-sm md:text-base">
              Explore Now
            </a>
            <a href="" className="bg-gray-900 text-white px-5 py-2 rounded-lg text-sm md:text-base">
              Join the Journey
            </a>
          </div>
        </div>
